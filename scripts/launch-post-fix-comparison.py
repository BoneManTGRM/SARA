...
def request(method, url, credential, maximum, body=None):
    headers = {"Accept": "application/json", "User-Agent": "SARA-Authorized-PostFix-Comparison/1"}
    if credential:
...
def validate_identity(value, runtime, run_id, workflow):
    ...
    expected_settings = {"maximumSpendUsd": .15, "maximumModelSpendUsdPerArm": .075,
        ...
        "execution": "existing_matched_cli_only", "authenticatedLaunchPath": "/api/coding-benchmark/run"}
