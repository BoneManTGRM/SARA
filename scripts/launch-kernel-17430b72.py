...
ID = "17430b72-1b04-4b9f-8f1c-e75b8b5f4235"
COMPETING = "68990425-bf42-4ec5-a4f1-e6af301780ac"
OUT = Path("/tmp/sara-kernel-17430b72")
...
def validate(value, runtime, run_id, workflow, fresh=False):
    expected = {"sourceRevision": runtime, "benchmarkId": ID, "historicalHold": HOLD,
        ...
        "exclusiveContinuation": {"benchmarkId": COMPETING, "status": "not_started", "files": []},
