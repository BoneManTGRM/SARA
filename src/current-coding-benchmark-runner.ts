// Experiment-local copy: frozen production benchmark runner is unchanged.
...
export async function runCodingBenchmarkArm(input: {
  ...
  model: CodingRepairModel;
  limits?: CodingRepairLimits;
  verifyFinal?: (candidate: ProgramCandidateProposal) => Promise<ProgramVerificationResult>;
