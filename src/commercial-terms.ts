...
export const COMMERCIAL_TERMS_VERSION = "public-repository-readiness-2026-09-03-v1" as const;
...
export type CommercialTerms = {
  ...
  turnaround: "Three business days after verified payment and owner fulfillment approval";
  clauses: string[];
};
