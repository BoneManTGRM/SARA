...
import {isolatedRepairDefinition} from './engineering/repair.ts';
import {nicoDefinitions} from './nico/definitions.ts';
import {webDefinitions} from './web/definitions.ts';
import {agentDefinitions} from './agents/definitions.ts';
...
const DEFINITIONS:readonly CapabilityDefinition[]=[...softwareWorkDefinitions,reproductionDefinition,isolatedRepairDefinition,...foundationDefinitions,...engineeringDefinitions,...troubleshootingDefinitions,...secretaryDefinitions,...economicDefinitions,...businessDefinitions,...proceduralDefinitions,...selfManagementDefinitions,...nicoDefinitions,...webDefinitions,...agentDefinitions];
const COMMON_FILES=["goal-plan.ts","economic-scheduling.ts","types.ts","schema.ts","registry.ts","evidence.ts","boundary.ts","receipt.ts","receipt-dependencies.ts","foundation.ts","../kernel.ts","../owner-software-recovery.ts","../owner-work.ts","../owner-software-work.ts","../owner-service-work.ts","../revenue-service-catalog.ts","../revenue-job-accounting.ts","../revenue-repository-collection.ts","../owner-work-inputs.ts","../owner-defect-work.ts","../learning-campaign.ts","../policy.ts","../effect-boundary.ts","../canonical.ts","../memory-fabric.ts","../server.ts","production-proof.ts","observed-evidence.ts","plan.ts"];
